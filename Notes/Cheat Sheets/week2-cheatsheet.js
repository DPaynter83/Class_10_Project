...
*/
let globalScope = "This is a globe scope";
...
if (userAge >= 21) {
  // nested condition
    if (cartValue >= 300 || points >= 500) {//if(false || true) === if(true)
      baseShipping = 0;
...
if(grade > 90){
  ...
  randomvar = "ok but work on it"
  console.log("C")
}else if(grade > 65){
  randomvar = "needs work"
  console.log("D")
}else{
  randomvar = "work harder"
  console.log("F")
}
